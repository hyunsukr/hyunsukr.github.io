...
*========================================================;
	*Chapter 8: Residual Analysis (8.1-8.5)
	...
	3. Normally Distributed (errors are normally distributed) 
...
proc reg data=homesales6 plots(only)=(residualbypredicted residualplot qqplot 
  residualhistogram);*add code from class;
model price = size quality quality2 schooldum1 schooldum2; run;
