...
*Chapter 7: Some Regression Pitfalls (7.1-7.4)
	...
	- Observational data
		- send out survey and record then try to divide into groups and run analysis
		- NO maniupulation to the subjects
	- Experimental design
		- manipulating subjects
		- Giving different treatments to some subjects
	...
	- The magnitude of the Beta-hat estimate does not imply
		...
		- If beta hat 1 is 100, beta 1 is not a better predictor is not more important
...
run;
*remove the highest vif or do variable screening;
