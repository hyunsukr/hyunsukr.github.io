...
unsigned short sum_AVX(long size, unsigned short *a) {
  ...
  for(int i = 0; i < size; i += 8) {
    total = total + extracted_partial_sums[i];
    total = total + extracted_partial_sums[i + 1];
    total = total + extracted_partial_sums[i+2];
    total = total + extracted_partial_sums[i+3];
    total = total + extracted_partial_sums[i+4];
    total = total + extracted_partial_sums[i+5];
    total = total + extracted_partial_sums[i+6];
    total = total + extracted_partial_sums[i+7];
